...
ECDSA.prototype.toPublicKey = function() {
  ...
  // Compute -e from e
  // .umod (not .mod) is required here: e.neg() is negative by construction,
  // and unlike older bn.js, current bn.js's .mod() on a negative operand
  // returns a truncated (still-negative) remainder rather than the
  // properly-reduced positive residue in [0, n) this recovery math needs.
